...
const validarLogueado = require ("../middelwares/validarLogueado");
...
router.get('/login', validarLogueado, usersControllers.login);
router.post('/login', validarLogin, usersControllers.logueado);
router.get('/register', validarLogueado, usersControllers.register);
